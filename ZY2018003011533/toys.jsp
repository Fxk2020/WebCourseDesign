                        ...
                        <td><div class="i01w">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td width="1"><img src="images/i14.gif" width="1" height="25" /></td>
                                    <td id="a4bg" align="center" width="166"><span id="a4color" onmouseover="showadv('a4','a4color','a4bg')"><a href="javascript:void(0)">童装玩具</a></span></td>
                                    <td width="1"><img src="images/i14.gif" width="1" height="25" /></td>
    ...
    <tr>
        <td colspan="6"  bgcolor="#e5e5e5" valign="top">
            <div class="banner" style="width: 100%">
                <div width="100%" style="height: 204px; background: url('image/toys.png') no-repeat center;background-size: 100% 204px">
                </div>
            </div>
        </td>
    </tr>
...
<div class="w_1200" style="">
    ...
    <table width="32%" border="0" cellspacing="0" cellpadding="0" style="float:left; border: 1px solid #dadada; margin-right: 8px;margin-bottom: 8px">
        <tr>
            <td width="52%" align="center" valign="middle"><a href="javascript:void(0)"><img name="news" src="Production/P15.jpg" width="100%" height="260" alt="" border="0" style=" border-color:#CCCCCC; margin-top:0px; margin-left:0px; margin-bottom:0px; margin-right:0px;" /></a></td>
            <td align="left" valign="top">
                <table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 14px">
                    <tr>
                        <td align="left" height="68" colspan="2" style="font-size:20px; padding-left: 0px;"><a href="javascript:void(0)">儿童羽绒服</a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="35" colspan="2" align="left" valign="middle" style="padding-left:2%;">
                            ...
                            <form method="post" name="buybuybuy" action="http://localhost:8080/ZY2018003011533/AddShoppingCarServlet" style="display: none">
                                ...
                                <input type="text" value="15" name="ID">
                                <input type="submit" name="" id="production15">
                            </form>


                            &nbsp;
                            <!-- 宝贝的详细介绍 -->
                            <img src="images/show_icon.png" alt="介绍" border="0" style="cursor:pointer;" onclick="javascript:window.open('introduce/introduce15.html','new','height=640,width=690,top=100,left=400');"/></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table width="32%" border="0" cellspacing="0" cellpadding="0" style="float:left; border: 1px solid #dadada; margin-right: 8px;margin-bottom: 8px">
        <tr>
            <td width="52%" align="center" valign="middle"><a href="javascript:void(0)"><img name="news" src="Production/P16.jpg" width="100%" height="260" alt="" border="0" style=" border-color:#CCCCCC; margin-top:0px; margin-left:0px; margin-bottom:0px; margin-right:0px;" /></a></td>
            <td align="left" valign="top">
                <table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 14px">
                    <tr>
                        <td align="left" height="68" colspan="2" style="font-size:20px; padding-left: 0px;"><a href="javascript:void(0)">乐高玩具</a></td>
                    </tr>
                    <tr>
                        <td height="35" align="left" valign="middle">品牌：</td>
                        <td> LEGO/乐高</td>
                    ...
                    <tr>
                        <td width="50" height="35" align="left" valign="middle" style="">简介：</td>
                        <td >乐高旗舰店官网2019新品哈利波特系列霍格沃茨城堡71043玩具积木</td>
                    </tr>
                    <tr>
                        <td height="35" align="left" valign="middle">价格：</td>
                        <td>RMB: 3999.00</td>
                    ...
                    <tr>
                        <td height="35" colspan="2" align="left" valign="middle" style="padding-left:2%;">
                            ...
                            <form method="post" name="buybuybuy" action="http://localhost:8080/ZY2018003011533/AddShoppingCarServlet" style="display: none">
                                <input type="text" value="<%=username%>" name="name">
                                <input type="text" value="16" name="ID">
                                <input type="submit" name="" id="production16">
                            </form>
                            &nbsp;
                            <!-- 宝贝的详细介绍 -->
                            <img src="images/show_icon.png" alt="介绍" border="0" style="cursor:pointer;" onclick="javascript:window.open('introduce/introduce16.html','new','height=640,width=1190,top=100,left=200');"/></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table width="32%" border="0" cellspacing="0" cellpadding="0" style="float:left; border: 1px solid #dadada; margin-right: 8px;margin-bottom: 8px">
        <tr>
            <td width="52%" align="center" valign="middle"><a href="javascript:void(0)"><img name="news" src="Production/K5.jpg" width="100%" height="260" alt="" border="0" style=" border-color:#CCCCCC; margin-top:0px; margin-left:0px; margin-bottom:0px; margin-right:0px;" /></a></td>
            <td align="left" valign="top">
                <table width="95%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 14px">
                    <tr>
                        <td align="left" height="68" colspan="2" style="font-size:20px; padding-left: 0px;"><a href="javascript:void(0)">K5手机</a></td>
                    </tr>
                    <tr>
                        <td height="35" align="left" valign="middle">品牌：</td>
                        <td>OPPO</td>
                    ...
                    <tr>
                        <td width="50" height="35" align="left" valign="middle" style="">简介：</td>
                        <td >OPPO K5全面屏6400万四摄4G拍照游戏智能手机
                            6400万超清四摄</td>
                    </tr>
                    <tr>
                        <td height="35" align="left" valign="middle">价格：</td>
                    ...
                    <tr>
                        <td height="35" colspan="2" align="left" valign="middle" style="padding-left:2%;">
                            ...
                            <form method="post" name="buybuybuy" action="http://localhost:8080/ZY2018003011533/AddShoppingCarServlet" style="display: none">
                                <input type="text" value="<%=username%>" name="name">
                                <input type="text" value="17" name="ID">
                                <input type="submit" name="" id="production17">
                            </form>
                            &nbsp;
                            <!-- 宝贝的详细介绍 -->
                            <img src="images/show_icon.png" alt="介绍" border="0" style="cursor:pointer;" onclick="javascript:window.open('introduce/introduce17.html','new','height=640,width=1190,top=100,left=200');"/></td>
                    </tr>
                </table>
            </td>
        </tr>
...
<script>
    function production16() {
        $("#production16").click();
    }
    function production15() {
        $("#production15").click();
    }
    function production17() {
        $("#production17").click();
    }
</script>
